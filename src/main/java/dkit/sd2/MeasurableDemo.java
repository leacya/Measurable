...
//        
//TODO
/* Exercise:9.16 Book page 459

    Write a method:
        public static Measurable maximum(Measurable[] objects)

    that returns the object with the largest measure.
    Use that method to determine the country with the largest areae from an array of countries.

  */

//    Solution - see MeasurableDemoMods.java 
}
